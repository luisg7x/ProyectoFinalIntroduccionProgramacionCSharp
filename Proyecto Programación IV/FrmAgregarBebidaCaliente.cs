...
{
    public partial class FrmAgregarBebidaCaliente : Form
    {
        string[] rols = new string[6];
        string codigoValor = string.Empty;
        public FrmAgregarBebidaCaliente()
        {
            InitializeComponent();
            codigo();
       ...
       private void buttonExit_Click(object sender, EventArgs e)
        ...
        private void agregar()
        {
            ...
            if (validar() == false)
            {
               ...
               if (cLogica_BD.agregar_BebidaCaliente() == true)
                {
                    Bitacora("Se agrego una Bebida Caliente", "Se agrego una Bebida Caliente");
        ...
        private void codigo()
        {
            ...
            string[] valores = clogiga.CodigoTabla("CodigoBebida", "BebidaCalientes");

...
{
    public partial class FrmAgregarUtencilios : Form
    {

        string[] rols = new string[6];
        string codigoValor = string.Empty;
        public FrmAgregarUtencilios()
        {
            InitializeComponent();
            codigo();
            cargarComboMarca();
        ...
        private void agregar()
        {
            ...
            if (validar() == false)
            {
                ...
                if (cLogica_BD.agregar_Utencilio() == true)
                {
                    Bitacora("Se agrego un Utencilio", "Se agrego un Utencilio");
        ...
        private void codigo()
        {
            ...
            string[] valores = clogiga.CodigoTabla("CodigoUtencilios", "Utencilios");

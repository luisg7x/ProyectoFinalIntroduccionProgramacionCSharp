...
{
    public partial class FrmAgregarBebidaGaseosa : Form
    {
        string[] rols = new string[6];
        string codigoValor = string.Empty;
        public FrmAgregarBebidaGaseosa()
        {
            InitializeComponent();
            codigo();
            cargarComboMarca();
       ...
       private void buttonExit_Click(object sender, EventArgs e)
        ...
        {
            if (string.IsNullOrEmpty(textBoxNombre.Text) || string.IsNullOrEmpty(textBoxPrecio.Text) || pictureBox2.Image == null || string.IsNullOrEmpty(textBoxRestaurante.Text) || string.IsNullOrEmpty(textBoxCantidad.Text) || string.IsNullOrEmpty(textBoxDescripcion.Text))
            {
        ...
        private void agregar()
        {
            ...
            if (validar() == false)
            {
               ...
               if (cLogica_BD.agregar_BebidaGaseosa() == true)
                {
                    Bitacora("Se agrego una Bebida Gaseosa", "Se agrego una Bebida Gaseosa");
        ...
        private void codigo()
        {
            ...
            string[] valores = clogiga.CodigoTabla("CodigoBebida", "BebidaGaseosas");

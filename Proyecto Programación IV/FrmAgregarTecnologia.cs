...
{
    public partial class FrmAgregarTecnologia : Form
    {
        string[] rols = new string[6];
        string codigoValor = string.Empty;
        public FrmAgregarTecnologia()
        {
            InitializeComponent();
            codigo();
            cargarComboMarca();
        ...
        private void agregar()
        {
            ...
            if (validar() == false)
            {
                ...
                if (cLogica_BD.agregar_Tecnologia() == true)
                {
                    Bitacora("Se agrego un objeto de Tecnologia", "Se agrego un objeto de Tecnologia");
        ...
        private void codigo()
        {
            ...
            string[] valores = clogiga.CodigoTabla("CodigoTecnologia", "Tecnologias");

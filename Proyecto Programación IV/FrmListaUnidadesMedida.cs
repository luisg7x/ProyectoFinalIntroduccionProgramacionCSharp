...
{
    public partial class FrmListaUnidadesMedida : Form
    {
  
        BaseDeDatos bd = new BaseDeDatos();
        string[] rols = new string[6];
        public FrmListaUnidadesMedida()
        {
            InitializeComponent();
            actualizarDataGrid("select CodigoUnidad,UnidadMedida,EscalaMedida,DetalleMedida,SimbologiaMedida from UnidadesMedida");
        ...
        private void dataGridView1_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            bd.executecommand("update UnidadesMedida set UnidadMedida='" + clogiga.encriptacion(dataGridView1.Rows[e.RowIndex].Cells[1].Value.ToString()) + "',EscalaMedida='" + clogiga.encriptacion(dataGridView1.Rows[e.RowIndex].Cells[2].Value.ToString()) + "',DetalleMedida='" + clogiga.encriptacion(dataGridView1.Rows[e.RowIndex].Cells[3].Value.ToString()) + "',SimbologiaMedida='" + clogiga.encriptacion(dataGridView1.Rows[e.RowIndex].Cells[4].Value.ToString()) + "'WHERE CodigoUnidad='" + clogiga.encriptacion(id) + "'");
            Bitacora("Actualizo una Unidad de Medida de la lista", "Actualizo una Unidad de Medida");
        }
        ...
        private void buttonBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(TextboxCodigo.Text) && string.IsNullOrEmpty(TextboxNombre.Text)) actualizarDataGrid("Select CodigoUnidad,UnidadMedida,EscalaMedida,DetalleMedida,SimbologiaMedida from UnidadesMedida where CodigoUnidad= '" + clogiga.encriptacion(TextboxCodigo.Text) + "'");
            if (!string.IsNullOrEmpty(TextboxNombre.Text) && string.IsNullOrEmpty(TextboxCodigo.Text)) actualizarDataGrid("Select CodigoUnidad,UnidadMedida,EscalaMedida,DetalleMedida,SimbologiaMedida from UnidadesMedida where UnidadMedida= '" + clogiga.encriptacion(TextboxNombre.Text) + "'");
            if (!string.IsNullOrEmpty(TextboxNombre.Text) && !string.IsNullOrEmpty(TextboxCodigo.Text)) actualizarDataGrid("Select CodigoUnidad,UnidadMedida,EscalaMedida,DetalleMedida,SimbologiaMedida from UnidadesMedida where UnidadMedida= '" + clogiga.encriptacion(TextboxNombre.Text) + "' and CodigoUnidad='" + clogiga.encriptacion(TextboxCodigo.Text) + "'");
        ...
        {
            bd.autocompletar("select UnidadMedida from UnidadesMedida", "UnidadMedida", 1, TextboxNombre);
            bd.autocompletar("select CodigoUnidad from UnidadesMedida", "CodigoUnidad", 1, TextboxCodigo);
        }
        ...
        {
            FrmAgregarUnidadesMedida frm = new FrmAgregarUnidadesMedida();
        ...
        private void buttonEliminar_Click(object sender, EventArgs e)
        {
            ...
            {   
                ...
                bd.executecommand("delete UnidadesMedida WHERE CodigoUnidad='" + clogiga.encriptacion(id) + "'");
                actualizarDataGrid("select CodigoUnidad,UnidadMedida,EscalaMedida,DetalleMedida,SimbologiaMedida from UnidadesMedida");
                Bitacora("Elimino una Unidad de Medida de la lista", "Elimino una Unidad de Medida");

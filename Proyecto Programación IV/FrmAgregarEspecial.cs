...
{
    public partial class FrmAgregarEspecial : Form
    {
        string[] rols = new string[6];
        string codigoValor = string.Empty;
        public FrmAgregarEspecial()
        {
            InitializeComponent();
            codigo();
       ...
       private void buttonExit_Click(object sender, EventArgs e)
        ...
        {
            if (string.IsNullOrEmpty(textBoxNombre.Text) || string.IsNullOrEmpty(textBoxPrecio.Text) || pictureBox2.Image == null || string.IsNullOrEmpty(textBoxIngredientes.Text) || string.IsNullOrEmpty(textBoxDetalle.Text))
            {
        ...
        private void agregar()
        {
            ...
            if (validar() == false)
            {
                ...
                cLogica_BD.descripcion = textBoxDetalle.Text;
                cLogica_BD.foto = imageToByteArray(pictureBox2.Image);

               if (cLogica_BD.agregar_Especiales() == true)
                {
                    Bitacora("Se agrego un Especial", "Se agrego un Especial");
        ...
        private void codigo()
        {
            ...
            string[] valores = clogiga.CodigoTabla("CodigoEspecial", "Especiales");

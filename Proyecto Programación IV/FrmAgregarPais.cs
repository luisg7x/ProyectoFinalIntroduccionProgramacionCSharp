...
namespace Proyecto_Programación_IV
{
    public partial class FrmAgregarPais : Form
    {
       ...
       private void buttonExit_Click(object sender, EventArgs e)
        ...
        {
            if (string.IsNullOrEmpty(textBoxNombre.Text) || pictureBox2.Image == null)
            {
        ...
        private void agregar()
        {
            ...
            if (validar() == false)
            {
               ...
               if (cLogica_BD.agregar_Pais() == true)
                {
                    Bitacora("Agrego Pais", "Agrego Pais");
        ...
        private void codigo()
        {
            ...
            string[] valores = clogiga.CodigoTabla("CodigoPais", "Paises");

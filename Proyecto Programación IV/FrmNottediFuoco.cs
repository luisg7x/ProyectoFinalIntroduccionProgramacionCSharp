...
{
    public partial class FrmNottediFuoco : Form
    {
        ...
        {   //TABLA CON LOS DATOS ENCRIPTADOS
            ...
            string restaurante = clogiga.encriptacion("Notte Di Fuoco");
        ...
        public void MesasOcupada(string mesa)
        {
            ...
            if (mesa.Equals("24"))
            {
                if (!string.IsNullOrEmpty(MesaOcupada))
                {
                    ...
                    buttonMesa24.BackColor = Color.Gray;
                }
            }
            if (mesa.Equals("25"))
            {
                if (!string.IsNullOrEmpty(MesaOcupada))
                {
                    ...
                    buttonMesa25.BackColor = Color.Gray;
                }
            }
            if (mesa.Equals("26"))
            {
                if (!string.IsNullOrEmpty(MesaOcupada))
                {
                    ...
                    buttonMesa26.BackColor = Color.Gray;
                }
            }
            if (mesa.Equals("27"))
            {
                if (!string.IsNullOrEmpty(MesaOcupada))
                {
                    ...
                    buttonMesa27.BackColor = Color.Gray;
                }
            }
            if (mesa.Equals("28"))
            {
                if (!string.IsNullOrEmpty(MesaOcupada))
                {
                    ...
                    buttonMesa28.BackColor = Color.Gray;
                }
            }
        ...
        {
            if (buttonMesa24.BackColor == Color.Gray) //buton mesa
            {
                ocupa("24"); //mesa
        ...
        {
            if (buttonMesa25.BackColor == Color.Gray) //buton mesa
            {
                ocupa("25"); //mesa
        ...
        {
            if (buttonMesa26.BackColor == Color.Gray) //buton mesa
            {
                ocupa("26"); //mesa
        ...
        {
            if (buttonMesa27.BackColor == Color.Gray) //buton mesa
            {
                ocupa("27"); //mesa
        ...
        {
            if (buttonMesa28.BackColor == Color.Gray) //buton mesa
            {
                ocupa("28"); //mesa
